...
<div id="main" style="padding-top:5;margin-top:15px;">
    <p style="font-size:30px;text-align:center;font-family:lucida handwriting;font-weight:bold;color:#f56600;">Update Tracking Status</p>
<hr/>
<br/>
<br/>

<form action="statuscode.py" method="post">
 <table style="color:#0d47a1;font-size:20px;font-weight:bold;width:50%;height:250px;" border="0" align="center">
     <tr>
	   <td>Change Status</td>
